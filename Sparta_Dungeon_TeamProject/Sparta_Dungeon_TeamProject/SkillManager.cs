...
namespace Sparta_Dungeon_TeamProject
{
    ...
    public class SkillManager
    {
        ...
        public static List<SkillLibrary> AllSkills = new List<SkillLibrary>
        {
            ...
            new SkillLibrary("능숙한 이간질", "시간이 지나도 그녀의 말솜씨는 여전하다.", 20, 4),
            // 과학자 스킬 ( 8 ~ 11 )
            new SkillLibrary("부식의 바늘", "치명적인 약품을 투약해, 적을 중독 시킵니다.", 40, 3),
            new SkillLibrary("적응형 돌연변이", "현재 상황에 적합한 형태로 몸을 변화시킵니다.", 40, 5),
            new SkillLibrary("즉효성 유전자 교란", "적을 피실험체로 사용해 유전자를 재구성 시킵니다.", 30, 4),
            new SkillLibrary("세포 분열 촉진제", "부작용을 감수하고, 병약한 세포를 촉진 시키는 약물을 복용합니다.", 60, 5),
            // 대장장이 스킬 ( 12 )
            new SkillLibrary("잃어버린 불꽃", "자신에 체력이 낮을 때, 일정 시간동안 공격력을 크게 상승시킵니다.", 0, 0),
            // 영매사 스킬 ( 13 ~ 16 )
            new SkillLibrary("전하고 싶었던 말", "그녀가 쓰러진 이들의 목소리를 들려줍니다.", 30, 2),
            new SkillLibrary("쇠와 꽃은 기억하리", "이 땅에 .", 20, 4),
            new SkillLibrary("저편에 메아리", "시간이 지나도 그녀의 말솜씨는 여전하다.", 20, 4),
            new SkillLibrary("능숙한 이간질", "시간이 지나도 그녀의 말솜씨는 여전하다.", 20, 4),
        };
